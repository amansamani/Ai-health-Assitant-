...
const styles = StyleSheet.create({
  ...
  rankTitle: { color: "#fff", fontSize: 22, fontWeight: "900", marginTop: 2 },
  ...
  achievementsButton: { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, backgroundColor: COLORS.primary, borderRadius: 18, paddingVertical: 15 },
  achievementsButtonText: { color: "#fff", fontWeight: "900", fontSize: 14 },
});
