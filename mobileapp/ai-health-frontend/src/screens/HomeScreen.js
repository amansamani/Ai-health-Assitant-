  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        {/* HERO CARD */}
        <LinearGradient colors={["#1F2937", "#111827"]} style={styles.heroCard}>
        ...
        <View style={styles.actions}>
          ...
          >
            <View style={styles.logMealRow}>
              <View>
                <Text style={[styles.actionTitle, { color: "#fff" }]}>🍛 Log Meal</Text>
                <Text style={[styles.actionSub, { color: "#ffe0b2" }]}>Track today's food intake</Text>
              </View>
              <View style={styles.logMealBadge}>
                <Text style={styles.logMealBadgeText}>+ Add</Text>
              </View>
            </View>
          </Pressable>

          <Pressable style={styles.actionCard} onPress={() => navigation.navigate("NutritionDashboard")}>
...
const styles = StyleSheet.create({
  ...
  // ← padding moved here from container so scroll works edge-to-edge
  scrollContent: {
    padding: 20,
  },
  ...
  heroCard:      { borderRadius: 22, padding: 24, marginBottom: 24, ...SHADOW },
  heroBadge:     { color: "#FACC15", fontSize: 12, fontWeight: "700", marginBottom: 8 },
  heroTitleDark: { fontSize: 20, fontWeight: "700", color: "#fff" },
  heroBig:       { fontSize: 28, fontWeight: "800", color: "#fff", marginTop: 12 },
  heroUnit:      { fontSize: 14, color: "#D1D5DB" },
  heroSubDark:   { fontSize: 14, color: "#D1D5DB", marginTop: 10 },

  trackHeader: { flexDirection: "row", justifyContent: "space-between", marginBottom: 14 },
  sectionTitle: { fontSize: 18, fontWeight: "700", color: COLORS.textDark },
  editText:     { fontSize: 13, fontWeight: "600", color: COLORS.primary },

  ringRow: { flexDirection: "row", justifyContent: "space-between", marginBottom: 24 },

  actions:    { marginTop: 10 },
  actionCard: {
    backgroundColor: COLORS.card,
    padding: 18, borderRadius: 18, marginBottom: 16, ...SHADOW,
  },
  actionTitle: { fontSize: 18, fontWeight: "700", color: COLORS.textDark },
  actionSub:   { fontSize: 14, color: COLORS.textLight, marginTop: 6 },

  logMealCard: { backgroundColor: "#FF6F00" },
  logMealRow:  { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  logMealBadge: {
    backgroundColor: "rgba(255,255,255,0.25)",
    paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20,
  },
  logMealBadgeText: { color: "#fff", fontWeight: "800", fontSize: 14 },
});