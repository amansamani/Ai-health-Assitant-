...
const styles = StyleSheet.create({
  ...
  section: { marginTop: 22, marginBottom: 9, fontSize: 10.5, letterSpacing: 1, fontWeight: "800", color: COLORS.textMuted },
  ...
  developerAvatar: { width: 56, height: 56, borderRadius: 16, backgroundColor: COLORS.surfaceMuted, borderWidth: 1, borderColor: COLORS.border, alignItems: "center", justifyContent: "center", marginRight: 12 },
  developerInitial: { fontSize: 23, fontWeight: "800", color: COLORS.primary },
  developerCopy: { flex: 1 },
  developerName: { fontSize: 17, fontWeight: "800", color: COLORS.textDark },
  ...
  copy: { flex: 1 },
  rowTitle: { fontSize: 13.5, fontWeight: "800", color: COLORS.textDark },
