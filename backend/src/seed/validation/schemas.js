...
const trackingSchema = z
  .object({
    ...
    activityType: z.string().trim().min(1).max(40).optional(),
    activityLabel: z.string().trim().min(1).max(40).optional(),
    activityMinutes: z.coerce.number().min(0).max(1440).optional(),
    activityMet: z.coerce.number().min(0).max(30).optional(),
    caloriesSource: z
